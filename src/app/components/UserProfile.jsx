...
import ReposUrl from "./ReposUrl";
import { useRef, useEffect } from 'react';


const UserProfile = ({ userData }) => {
    const reposUrlRef = useRef(); // Create a ref for the ReposUrl component

  useEffect(() => {
    // Scroll to the ReposUrl component when the component is mounted
    if (reposUrlRef.current) {
      reposUrlRef.current.scrollIntoView({ behavior: "smooth" });
    }
  }, []);
	return (
		<>
            ...
            <ReposUrl reposUrl ={userData.repos_url}/>
